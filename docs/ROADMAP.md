...
- Creación/entrega de DesignProof y UI cliente para aprobar/cambiar.
- Historial visual de versiones, comentarios y notificaciones.
- Undo/redo, snapping, safe zones y control de DPI en editor.
